...
!function(t){function n(n){n.mp_title&&n.mp_title.length>0&&(t("#mp_title").html(n.mp_title),t("title").html(n.mp_title));var e="";t.each(n.states,function(){t.each(this,function(n,i){i.href?(i.target||(i.target="_blank"),e+="<li id='"+n+"'><a class='icon "+i.icon+"' href='"+i.href+"' target='"+i.target+"'>"+i.display+"</a></li>"):e+="<li id='"+n+"'><a class='icon "+i.icon+"' href='#1'>"+i.display+"</a></li>",t("#"+n).on("click",i.click)})}),t(n.toolbarselector).find("ul").append(e),c(e)}function e(n){t.each(n.states,function(){t.each(this,function(e){t("#"+e).on("click",function(){console.log(e+"--click"),i(n,e)})})}),t("#all").click(function(){t.each(n.states,function(){t.each(this,function(n){t("."+n).show()})})})}function i(n,e){t.each(n.states,function(){t.each(this,function(n){t("."+n).hide()})}),t("."+e).show(),t(n.menu_trigger_selector).trigger("click")}function o(n){var e=n.default_state;"all"===e?(t.each(n.states,function(){t.each(this,function(n){t("."+n).show()})}),t(n.menu_trigger_selector).trigger("click")):i(n,e)}function c(n){t.transtool.options.debug===!0&&console.log(n)}t.transtool=function(i){var c=t.extend({},t.transtool.options,i);n(c),e(c),o(c)},t.transtool.options={debug:!1,mp_title:"请配置mp_title",toolbarselector:"#user-toolbar",menu_trigger_selector:"#normal-button",punctuation:".",states:[{zh:{icon:"icon-edit",href:"http://baidu.com",target:"_self",click:function(){alert("zh")}},en:{icon:"icon-user",click:function(){alert("en")}}}]},t.expr[":"].transtool=function(n){return-1!==t(n).text().indexOf("awesome")}}(jQuery);
